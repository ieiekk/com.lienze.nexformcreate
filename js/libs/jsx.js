...
(function () {
  ...
  Jsx.prototype.evalScript = function () {
    ...
    if (args.length === 1 && (arg = args[0]) instanceof Object) {
      jsxScript =
        arg.jsxScript || arg.jsx || arg.script || arg.file || arg.jsxscript;
  ...
  Jsx.prototype.evalFile = function () {
    ...
    if (forceEvalScript) {
      ...
      if (!window.cep.fs.stat(jsxScript).err) {
        jsxScript =
          fileNameScript
            .replace(/__fileName__/, jsxScript)
            .replace(/__basename__/, path.basename(jsxScript)) +
          '$.evalFile(new File("' +
          jsxScript.replace(/\\/g, '\\\\') +
          '")) + "";';
    ...
    jsxScript =
      fileNameScript
        ...
        .replace(/__basename__/, path.basename(fileName)) +
      newLine +
      jsxScript;
  ...
  ////////////////////////////////////
  Jsx.prototype.eval =
    Jsx.prototype.script =
    Jsx.prototype.evalscript =
      Jsx.prototype.evalScript;
